...
<form:form action = "savePersonData" modelAttribute="formAllEntity">
    ...
    <table align="center" width="90%">
        ...
        <tr>
            <td align="center"><form:input path="person.surname"/></td>
<%--            <form:errors path="person.surname"/>--%>

            <td align="center"><form:input path="person.name"/></td>
<%--            <form:errors path="person.name"/>--%>

            <td align="center"><form:input path="person.phoneNumber"/></td>
<%--            <form:errors path="person.phoneNumber"/>--%>

            <td align="center"><form:input path="person.email"/></td>
<%--            <form:errors path="person.email"/>--%>

            <td align="center"><form:input path="person.birthday"/></td>
